...
&#8220;Here is a structured export from my reference manager. Each entry includes: title, year, journal, tags I assigned, and my annotation. Based on this, identify: (1) which papers are methodologically most similar to each other, (2) where the &#8216;contradicts&#8217; papers disagree with the &#8216;supports_main&#8217; group and what might explain the difference, and (3) what the tag set suggests is missing or underrepresented.&#8221;
...
Where AI Actually Fits in My Research Workflow covers the broader logic: AI performs best when it augments structured thinking rather than replacing it. Zotero is where that structure gets built.
...
On the question of which AI to use for this: Claude vs ChatGPT for Research Thinking outlines the differences in more detail. For structured input tasks requiring consistent logic across many records, the behavioral differences become apparent when you run the same export through both.
