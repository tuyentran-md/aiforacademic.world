...
What your field currently believes — the dominant framework, the accepted mechanisms, the working assumptions.
Where that understanding breaks down — the contradictions, the unexplained observations, the questions that remain open.
How your findings interact with those gaps — whether they support the current framework, challenge it, refine it, or add a new dimension.
