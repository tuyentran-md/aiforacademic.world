...
date: "2026-03-30T23:48:08"
excerpt: "Complex statistics often hide weak data. The best papers use the simplest method necessary."
category: "Foundations"
slug: "statistical-overcomplication-occams-razor-in-research-why"
---
...
This is one of the things [methodological rigor actually means in practice](/blog/methodological-rigor-clinical-vs-statistical-significance) — not whether the statistical tools are sophisticated, but whether the analytical decisions were made before looking at the data, and whether the complexity was warranted by the research question.
...
When [sample size is inadequate](/blog/sample-size-justification-underpowered-studies-when-to), no statistical adjustment compensates for it. The gap reshapes the conclusions you can legitimately draw, and papers that try to force full conclusions from underpowered data — regardless of how elaborately they do it — tend to fail in ways that are readily detectable.
