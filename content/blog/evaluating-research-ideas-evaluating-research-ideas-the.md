...
Originality
- [ ] Gap identified: a prior study does NOT already answer this question cleanly (0–2)
- [ ] Gap is specific: the reason for the gap is named, not inferred (0–2)


Feasibility
- [ ] Data exists and is accessible in usable form (0–2)
- [ ] Sample size estimate done and is achievable (0–2)
- [ ] Timeline fits current obligations (0–2)


Impact
- [ ] Finding would change clinical practice OR research direction (0–2)
- [ ] A journal exists that publishes this type of study with this scope (0–2)


Score interpretation:
- 12–14: Proceed to protocol development
- 8–11: Redesign before proceeding — identify which items scored 0–1 and address them
- Below 8: Stop. The idea needs more development or should be set aside
...
Want a complete checklist that takes you from idea evaluation through to journal submission? Get the Idea to Submission Checklist → — Every stage, every gate, in one document ($5)




    Prompt Pack: Paper Structuring


    25 tested prompts for structuring your paper with AI — from intro to revision.
